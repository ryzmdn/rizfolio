...
export const roadmapItems: RoadmapItemData[] = [
  ...
  {
    id: "rm-2",
    title: "Unified Search & Monorepo Cross-Linking",
    description:
      "Cross-application command palette search querying repositories, blog articles, and releases.",
    stage: "IN_PROGRESS",
    quarter: "Q4 2026",
    priority: "HIGH",
  ...
  },
  {
    ...
    description:
      "Live in-browser WebAssembly runner to test algorithms and distributed system nodes.",
    stage: "IN_PROGRESS",
    quarter: "Q4 2026",
    priority: "MEDIUM",
    scope: ["apps/docs"],
  },
  {
    ...
    description:
      "React Native and Expo companion application for personal analytics, notifications, and dev logs.",
    stage: "PLANNED",
    quarter: "Q1 2027",
    priority: "PLANNED",
    scope: ["apps/mobile"],
  },
  {
    ...
    description:
      "Global edge routing with distributed edge worker caching reads within 20ms worldwide.",
    stage: "PLANNED",
    quarter: "Q2 2027",
    priority: "MEDIUM",
