      ...
      <Container className="py-20">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            ...
            >
              <div className="relative aspect-video w-full overflow-hidden rounded-3xl bg-muted sm:aspect-2/1 lg:aspect-3/2">
                <Image
                  src={post.imageUrl}
                  alt={post.imageUrl}
                  fill
                ...
                />
                <div className="absolute inset-0 rounded-3xl inset-ring inset-ring-primary/10" />
              </div>
              <div className="relative grow">
                <h3 className="mt-6 text-lg/6 font-semibold text-primary inset-ring-primary lg:text-xl">
                  <a href={post.href}>
