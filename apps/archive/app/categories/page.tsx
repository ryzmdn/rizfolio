...
export default async function CategoriesIndexPage() {
  ...
  return (
    <Container className="py-12 space-y-10">
      <div className="space-y-3 max-w-2xl border-b border-border/70 pb-6">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">
          Eksplorasi arsip kode sumber dan tugas akademik berdasarkan mata kuliah
          dan kurikulum universitas.
        </p>
      </div>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2.5">
                  <GraduationCap className="size-5 text-muted-foreground group-hover:text-foreground transition-colors" />
